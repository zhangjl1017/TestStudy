...
namespace WindowsFormsApplication1 {
    ...
    public partial class testDataSet1 : global::System.Data.DataSet {
        ...
        public partial class userDataTable : global::System.Data.TypedTableBase<userRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public userRow AdduserRow(string name, string password, string email) {
...
namespace WindowsFormsApplication1.testDataSet1TableAdapters {
    ...
    public partial class userTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `user` WHERE ((`id` = @Original_id) AND ((@IsNull_name = 1 AND `name` IS NULL) OR (`name` = @Original_name)) AND ((@IsNull_password = 1 AND `password` IS NULL) OR (`password` = @Original_password)) AND ((@IsNull_email = 1 AND `email` IS NULL) OR (`email` = @Original_email)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `user` (`name`, `password`, `email`) VALUES (@name, @password, @email" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `user` SET `name` = @name, `password` = @password, `email` = @email WHERE ((`id` = @Original_id) AND ((@IsNull_name = 1 AND `name` IS NULL) OR (`name` = @Original_name)) AND ((@IsNull_password = 1 AND `password` IS NULL) OR (`password` = @Original_password)) AND ((@IsNull_email = 1 AND `email` IS NULL) OR (`email` = @Original_email)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `id`, `name`, `password`, `email` FROM `user`";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT   id, name, password, email\r\nFROM      `user`";
